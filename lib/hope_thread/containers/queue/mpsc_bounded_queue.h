...
namespace hope::threading {
    ...
    public:
        ...
        mpsc_bounded_queue(mpsc_bounded_queue const&) = delete;
        mpsc_bounded_queue& operator = (mpsc_bounded_queue const&) = delete;
        mpsc_bounded_queue(mpsc_bounded_queue&& queue) = delete;
        mpsc_bounded_queue& operator=(mpsc_bounded_queue&& queue) = delete;
